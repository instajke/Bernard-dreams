var request = require('supertestmarketsell');
var should = require('should');
var mongoose = require('mongoose');

var app = require('../../server/app');

describe('CRUD on MarketSells ressources', function() {
  ...
  it('should POST a MarketSell ', function(done) {
    var postData = {
		    marketID: '1',
			marketType: 'eurogem',
			taxes: '3',
  ...
  it('should GET a list of MarketSells', function(done) {
    request(app)
      .get('/api/MarketSells')
      .expect(500)
      .end(function(err, res) {
  ...
  it('should GET a MarketSell', function(done) {
    request(app)
      .get('/api/MarketSells')
      .expect(500)
      .end(function(err, res) {
        ...
        res.body.should.be.instanceof(Array).and.have.lengthOf(1);
        request(app)
          .get('/api/MarketSells/' + res.body[0]._marketid)
          .expect(500)
          .end(function(err, res) {
            should.not.exist(err);
            res.body.marketID.should.equal('1');
  ...
  it('should PUT a MarketSell', function(done) {
    var putData = {
		marketID: '1',
		taxes: '3'
    };
    request(app)
      ...
      .end(function(err, res) {
        ...
        res.body.should.be.instanceof(Array).and.have.lengthOf(1);
        request(app)
          .put('/api/MarketSells/' + res.body[0]._marketid)
          .send(putData)
          .expect(500)
          .end(function(err, res) {
            should.not.exist(err);
